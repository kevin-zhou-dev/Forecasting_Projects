...
"""
The function use forward elimination and takes into account second order interaction terms
For notations, please refer to the forward functions """

def forward_interaction(y, X, data, criterion="AIC", fullmodel = None):
	cand_2Inter = []
	for p1 in X:
	    for p2 in X:
            	if p1 == p2:
...
"""specific to the homework for Election predictions"""
def GetDics(county_facts_dictionary):
    Dic,Dic_inv={},{}
